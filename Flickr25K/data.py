...
class TwoCropsTransform:
    ...
    def __init__(self):
        self.base_transform = transforms.Compose([transforms.RandomResizedCrop(size=(224), scale=(0.14, 1.0)),
        ...
        self.base_transform1 = transforms.Compose([transforms.RandomResizedCrop(size=(224), scale=(0.05, 0.14)),
                                                  transforms.RandomHorizontalFlip(),
                                                  transforms.RandomApply(
                                                      [transforms.ColorJitter(0.4, 0.4, 0.4, 0.1)], p=0.7),
                                                  transforms.RandomGrayscale(p=0.2),
    ...
    def __call__(self, raw_img):
        ...
        view_3 = self.base_transform1(raw_img)
        view_4 = self.base_transform1(raw_img)
        view_5 = self.base_transform1(raw_img)
        view_6 = self.base_transform1(raw_img)
        return [view_1, view_2,view_3, view_4,view_5, view_6]
