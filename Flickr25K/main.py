...
from network import DCCQ
from loss import DCCQLoss
from engine import train, test

def parse_args():
    parser = ArgumentParser(description="Run DCCQ")
    parser.add_argument('--dataset', 
                        type=str, default='Flickr25K',
                        help="Choose a dataset from 'CIFAR10', 'Flickr25K' or 'NUSWIDE'.")
    parser.add_argument('--protocal', 
                        type=str, default='I',
                        help="Select evaluation protocal on CIFAR10. Options: 'I'.")
...
if __name__ == '__main__':
    ...
    model = DCCQ(feat_dim=config.feat_dim, 
